...
public class TicketRequester
{
    ...
    public static String put(Message message, int numTickets)
    {
      ...
      try {
        ...
        Destination purchaseQueueDestination = session.createQueue(PURCHASE_QUEUE);
        // Create a MessageProducer
        MessageProducer producer = session.createProducer(purchaseQueueDestination);
        // Send the Request
    ...
    public boolean get(String correlationID) {
      ...
      try {
        ...
        Destination confirmationQueueDestination = session.createQueue(CONFIRMATION_QUEUE);
        MessageConsumer consumer = session.createConsumer(confirmationQueueDestination);
